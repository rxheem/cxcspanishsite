...
if (true) {
  var _browser = detect(); // alert(browser.name);
...
var SystemInfo = function SystemInfo(props) {
  return __jsx("div", null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["Row"], null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["Col"], {
    ...
    lg: 3,
    xl: 3
  }, __jsx("p", null, "Browser ", __jsx("b", null, browser))), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["Col"], {
    sm: 3,
    md: 3,
    lg: 3,
    xl: 3
...
//# sourceMappingURL=index.js.cf2d9dc940cbdc506f48.hot-update.js.map