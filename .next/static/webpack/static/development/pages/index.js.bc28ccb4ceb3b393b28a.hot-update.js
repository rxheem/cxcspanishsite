...
var Marketing = function Marketing(props) {
  return __jsx("div", {
  ...
  }), __jsx("br", null), __jsx("br", null), __jsx("h2", null, "Listening"), __jsx("p", null, "Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna."), __jsx("p", null, __jsx("a", {
    "class": "btn btn-secondary",
    href: "#",
    role: "button"
  }, "View details \xBB"))), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["Col"], {
    sm: 12,
    md: 4,
    lg: 4,
    xl: 4
    ...
    className: "rounded-circle"
  }), __jsx("br", null), __jsx("br", null), __jsx("h2", null, "Writing"), __jsx("p", null, "Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna."), __jsx("p", null, __jsx("a", {
    "class": "btn btn-secondary",
    href: "#",
    role: "button"
    ...
    className: "rounded-circle"
  }), __jsx("br", null), __jsx("br", null), __jsx("h2", null, "Speaking"), __jsx("p", null, "Donec sed odio dui. Etiam porta sem malesuada magna mollis euismod. Nullam id dolor id nibh ultricies vehicula ut id elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Praesent commodo cursus magna."), __jsx("p", null, __jsx("a", {
    "class": "btn btn-secondary",
    href: "#",
    role: "button"
  }, "View details \xBB")))));
...
//# sourceMappingURL=index.js.bc28ccb4ceb3b393b28a.hot-update.js.map