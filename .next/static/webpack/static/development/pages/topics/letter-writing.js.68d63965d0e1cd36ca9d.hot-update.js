...
var UsefulEssentials = function UsefulEssentials(props) {
  return __jsx(Fragment, null, __jsx("br", {
    className: "d-sm-none"
  }), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["Card"], null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["CardBody"], null, __jsx("h5", null, "Useful Essentials", " ", __jsx("div", {
    className: "spinner-grow text-success",
    role: "status"
  }, __jsx("span", {
    className: "sr-only"
  }, "Loading..."))), __jsx("p", null, "These phrases and vocabulary really come in handy when composing you letters. Take a read!"), __jsx("ul", {
    style: {
      listStyleType: "none",
      marginLeft: "-15px"
    },
...
//# sourceMappingURL=letter-writing.js.68d63965d0e1cd36ca9d.hot-update.js.map