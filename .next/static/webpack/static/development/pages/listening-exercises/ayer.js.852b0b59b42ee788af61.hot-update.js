...
var Ayer = function Ayer(props) {
  ...
  }, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["CardHeader"], null, __jsx("p", {
    style: {
      paddingTop: "10px"
    }
  }, "Ricardo: \xA1Te ves exhausta! \xBFQu\xE9 pasa?"), __jsx("p", null, "Kelly: Ayer fue un d\xEDa s\xFAper largo para m\xED y todav\xEDa no me he recuperado. Me levant\xE9 a las cinco y media. Hice ejercicio por media hora. Desayun\xE9, me vest\xED y sal\xED para el trabajo a las siete y media. Tuve dos reuniones importantes por la ma\xF1ana y un proyecto que entregar por la tarde as\xED que no descans\xE9 ni diez minutos. Sal\xED del trabajo a las cinco, cen\xE9 y fui a la universidad donde ense\xF1o una clase de espa\xF1ol. Me qued\xE9 ah\xED con mis estudiantes hasta las nueve de la noche. Cuando (5) a casa, me relaj\xE9 un rato. Cuando por fin me dorm\xED, eran las diez y media. F\xEDjate que todos los martes son as\xED para m\xED. Es una pesadilla."), __jsx("p", null, "Ricardo: \xA1Con raz\xF3n! Pobrecita. Pues los martes para m\xED no son tan pesados. Ayer me levant\xE9 a las seis y media de la ma\xF1ana. (6) la cara, los dientes y me vest\xED. Despu\xE9s (7) pan tostado con mermelada y una taza de caf\xE9. Me gusta desayunar ligero. Antes de irme al trabajo (8) las noticias de la ma\xF1ana como por diez minutos. Solamente quer\xEDa saber el pron\xF3stico del tiempo, para estar preparado."), __jsx("p", null, "Kelly: \xBFA qu\xE9 hora llegaste a tu casa?"), __jsx("p", null, "Ricardo: Pues llegu\xE9 como a las seis de la tarde. Habr\xEDa podido llegar m\xE1s temprano si no hubiera pasado al gimnasio."), __jsx("p", null, "Kelly: \xBFY qu\xE9 hiciste entre las seis y antes de dormir?"), __jsx("p", null, "Ricardo: Pues primero cen\xE9. Luego (9) un poco leyendo las noticias en el Internet y despu\xE9s us\xE9 un programa de videoconferencia para hablar con mi familia. Finalmente (10) y me fui a la cama como a las diez."), __jsx("p", null, "Kelly: \xA1Qu\xE9 envidia!"), __jsx("p", null, "Ricardo: Pues no te sientas mal porque mis lunes son horribles. Despu\xE9s del trabajo manejo una hora para ir a clases. Mi clase termina a las ocho de la noche y despu\xE9s tengo que manejar una hora de regreso. Es horrible."), __jsx("p", null, "Kelly: Estoy de acuerdo. Creo que despu\xE9s de este semestre nos habremos ganado unas muy merecidas vacaciones."))), __jsx("br", null), __jsx("br", null), __jsx("h6", null, "Questions"), __jsx("ul", {
    style: {
      marginLeft: "-20px"
    }
...
//# sourceMappingURL=ayer.js.852b0b59b42ee788af61.hot-update.js.map