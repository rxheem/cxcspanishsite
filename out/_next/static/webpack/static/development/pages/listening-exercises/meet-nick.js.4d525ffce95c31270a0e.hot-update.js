webpackHotUpdate("static/development/pages/listening-exercises/meet-nick.js",{

/***/ "./pages/listening-exercises/meet-nick.js":
/*!************************************************!*\
  !*** ./pages/listening-exercises/meet-nick.js ***!
  \************************************************/
...
var MeetNick = function MeetNick(props) {
  return __jsx(_components_Layout__WEBPACK_IMPORTED_MODULE_7__["default"], null, __jsx(react_seo_component__WEBPACK_IMPORTED_MODULE_8___default.a, {
    ...
    active: true
  }, "Meet Nick")), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["Row"], null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["Col"], {
    sm: 12,
    md: 8,
    lg: 8,
    xl: 8
  }, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["Card"], null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["CardBody"], null, __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["CardTitle"], null, "Meet Nick"), __jsx("p", null, "Meet Nick, ", __jsx("a", {
    href: "/listening-exercises/meet-ana"
  }, "Ana's"), " ", "husband. In this listening exercise we'll get to know a little about him. Listen to the audio below and answer the", " ", numberOfQuestions, " questions."), __jsx("br", null), __jsx("div", {
    className: "audio"
  }, __jsx("audio", {
    controls: true
  }, __jsx("source", {
    src: "https://dl.dropbox.com/s/q7myh8ug3oec0bd/Example%202%20-%20Nick.mp3?dl=0"
  ...
  }, __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null))), __jsx("br", null), __jsx("br", null), __jsx("h6", null, "Questions"), __jsx("ul", {
    style: {
      marginLeft: "-20px"
    }
  ...
  }, "Nick is an English teacher.", " "))), __jsx("li", {
    style: {
      paddingTop: "10px"
    }
  }, __jsx(react_collapsible__WEBPACK_IMPORTED_MODULE_3___default.a, {
  ...
  }, "His dog's name is Joey."))), __jsx("li", {
    style: {
      paddingTop: "10px"
    }
  }, __jsx(react_collapsible__WEBPACK_IMPORTED_MODULE_3___default.a, {
    trigger: __jsx("a", {
      href: ""
    }, "How long has Nick been studying Spanish.")
  }, __jsx("p", {
    style: {
      paddingTop: "10px"
    }
  }, "He has been studying Spanish for 8 years.", " "))), __jsx("li", {
    style: {
      paddingTop: "10px"
    }
  }, __jsx(react_collapsible__WEBPACK_IMPORTED_MODULE_3___default.a, {
    trigger: __jsx("a", {
      href: ""
    }, "Why does he like studying Spanish?")
  }, __jsx("p", {
    style: {
      paddingTop: "10px"
    }
  }, "He has always liked languages and words, and he believes that being able to talk with another group of people i sgratifying and very beneficial."))))))), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_2__["Col"], {
    sm: 12,
    md: 4,
    lg: 4,
    xl: 4
...
/* harmony default export */ __webpack_exports__["default"] = (MeetNick);

/***/ })

})
//# sourceMappingURL=meet-nick.js.4d525ffce95c31270a0e.hot-update.js.map