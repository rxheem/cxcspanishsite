...
var LaNavidad = function LaNavidad(props) {
  ...
  }, "Ricardo: \xA1Feliz Navidad Kelly!"), __jsx("p", null, "Kelly: \xA1Feliz Navidad! \xBFTe gusta esta temporada del a\xF1o?"), __jsx("p", null, "Ricardo: Pues s\xED y no. La verdad me encanta el tiempo con la familia y el intercambio de regalos, pero odio el fr\xEDo. \xBFY a ti?"), __jsx("p", null, "Kelly: Me gusta. Es muy festivo todo. \xBFQu\xE9 quieres que te (1) este a\xF1o?"), __jsx("p", null, "Ricardo: Pues en realidad no soy muy exigente. Me conformo con que me (2) y me (3) mis amigos y familiares. Aunque claro, siempre regalo y recibo algo, \xBFy t\xFA?"), __jsx("p", null, "Kelly: Mentiroso. Quieres que te (4) una televisi\xF3n de alta definici\xF3n. Te conozco. Honestamente, quiero que me (5) las cosas que no compro a menudo. Ropa, art\xEDculos para la cocina, libros, m\xFAsica. \xA1Me gusta regalar y recibir!"), __jsx("p", null, "Ricardo: \xBFC\xF3mo sabes de mi lista para Santa? Pues la verdad me encantar\xEDa una tele de alta definici\xF3n, pero con esta econom\xEDa, no creo que a Santa le parezca una buena idea. Pues, espero que (6) lo que (7) realmente a usar, y no cosas que terminan en el garaje."), __jsx("p", null, "Kelly: Mis cosas no terminan en el garaje. Terminan amontonadas en el armario de mi esposo. Ni modo. Bueno, qu\xE9 pases felices fiestas."), __jsx("p", null, "Ricardo: Igualmente. \xA1Hasta luego!")))))));
};
...
//# sourceMappingURL=la-navidad.js.475e1232609f5c17f7ea.hot-update.js.map