...
var UnaVisitaDeEspana = function UnaVisitaDeEspana(props) {
  ...
  }, __jsx("span", null, __jsx("b", null, "Kelly"), ": \xA1Hola, Ricardo! \xBFC\xF3mo est\xE1s?"), __jsx("br", null), __jsx("span", null, "Ricardo: Muy bien. \xBFQu\xE9 hay de nuevo?"), __jsx("br", null), __jsx("span", null, "Kelly: Pues, mi primo de Espa\xF1a lleg\xF3 de visita. Va a estar aqu\xED por un mes."), __jsx("br", null), __jsx("span", null, "Ricardo: \xA1Genial! \xBFPor qu\xE9 est\xE1 aqu\xED?"), __jsx("br", null), __jsx("span", null, "Kelly: Vino para visitar a la familia y practicar el ingl\xE9s. Me gustar\xEDa ir a Espa\xF1a alg\xFAn d\xEDa para hacer lo mismo."), __jsx("br", null), __jsx("span", null, "Ricardo: Ser\xEDa divertido. \xBFC\xF3mo es tu primo?"), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null), __jsx("br", null), __jsx("span", null))), __jsx("br", null), __jsx("br", null), __jsx("h6", null, "Questions"), __jsx("ul", {
    style: {
      marginLeft: "-20px"
    }
...
//# sourceMappingURL=una-visita-de-espana.js.c26576a3f47d2d4ec2f4.hot-update.js.map