...
var renderer = function renderer(_ref) {
  ...
  if (completed) {
    ...
    // Render a countdown
    return __jsx("span", null, days, " Days: ", hours, " hours ", minutes, " minutes to go!");
  }
};
...
var TwelveFifteen = function TwelveFifteen(props) {
  ...
  })), __jsx("br", null), __jsx("p", null, "As well as to answer any and every question that you may have!")), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["CardFooter"], {
    style: {
      color: "skyblue"
    }
  ...
  }), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["CardBody"], null, __jsx("br", null), __jsx("p", null, __jsx("b", null, "Driect Link"), " ", __jsx("a", {
    target: "_blank",
    href: "https://us04web.zoom.us/j/370403487"
  }, "https://us04web.zoom.us/j/370403487"), __jsx("b", null, "Meeting ID:"), " 370 403 487")), __jsx(shards_react__WEBPACK_IMPORTED_MODULE_1__["CardFooter"], null, " ", __jsx("b", null, __jsx(react_countdown__WEBPACK_IMPORTED_MODULE_6__["default"], {
    intervalDelay: 0,
    precision: 3,
    date: new Date("2/15/2020"),
    renderer: renderer
...
//# sourceMappingURL=12152020.js.f2f04224d75ced637920.hot-update.js.map