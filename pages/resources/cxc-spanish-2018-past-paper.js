...
const PastPaper2018 = props => (
  <Layout>
    <Head>
      <title>CXC Spansih 2018 Past Paper | CXC Spanish Guide</title>
      <meta
        name="og:title"
        content="CXC Spansih 2018 Past Paper |  CXC Spanish Guide"
      />
      <meta name="og:site_name" content="CXC Spanish Online" />
      <meta
        name="description"
        content="Get the CXC Spansih 2018 past paper in PDF format for free, along with the offical past paper booklet"
      />
    </Head>
    <Container>
      <Breadcrumb>
        ...
        <BreadcrumbItem active>2018 Past Paper</BreadcrumbItem>
      </Breadcrumb>
      ...
      <Row>
        <Col sm={12} md={8} lg={8} xl={8}>
          <Card>
            <CardBody>
              <CardTitle>CXC Spanish 2018 Past Paper</CardTitle>
              <br />
