...
const dlLink =
  "https://dl.dropbox.com/s/bf25mxz6l6nrz5x/CAPE%20Economics%20Past%20Papers%20U1%20_U2%202005-2016.pdf?dl=0";
const title = "Economics";

const Economics = props => (
  <Layout>
    <SEO
      title={"CAPE® Economics Past Papers eBook | CXC Spanish Online"}
      description={
        "Get the CAPE Economics past papers in PDF format for free, along with the offical past paper booklet."
      }
      pathname={""}
      siteLanguage={"en"}
