    ...
    <Container>
      <BrowserView>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>Computer Science</BreadcrumbItem>
        </Breadcrumb>
      </BrowserView>
        ...
        <Card>
          ...
          <CardBody>
            <Row>
              ...
              <Col sm={12} md={9}>
                <CardTitle>CAPE Computer Science Past Papers</CardTitle>
                <br />

                <p>
                  This document includes both Units I and II from May 2005 - May
                  2016 for CAPE Computer Science. Paper 1 is also included for
                  both units. January resits are not included.
                </p>
