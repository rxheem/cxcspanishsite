...
const Biology = props => (
  <Layout>
    <SEO
      title={"CAPE® Biology Past Papers eBook | CXC Spanish Online"}
      description={
        "Get the CAPE Biology past papers in PDF format for free, along with the offical past paper booklet."
      }
      pathname={""}
      siteLanguage={"en"}
