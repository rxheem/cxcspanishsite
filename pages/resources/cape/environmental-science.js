...
const dlLink =
  "https://dl.dropbox.com/s/5q7ordpl6wqf8sc/CAPE%20Environmental%20Science%20Past%20Papers%20Unit%201%20_%20%40%202005%20-%202016.pdf?dl=0";
const title = "Environmental Science";

const EnvironmentalScience = props => (
  <Layout>
    <SEO
      title={"CAPE® EnvironmentalSciencePast Papers eBook | CXC Spanish Online"}
      description={
        "Get the CAPE Environmental Science Science past papers in PDF format for free, along with the offical past paper booklet."
      }
      pathname={""}
      siteLanguage={"en"}
