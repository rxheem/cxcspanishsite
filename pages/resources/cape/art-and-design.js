...
const dlLink =
  "https://dl.dropbox.com/s/ypiop2ihdajo9hj/CAPE%20Art%20and%20Design%20Past%20Papers%20Unit1_2%202005-2016.pdf?dl=0";
const title = "Art and Design";

const ArtAndDesign = props => (
  <Layout>
    <SEO
      title={"CAPE® Art and Design Past Papers eBook | CXC Spanish Online"}
      description={
        "Get the CAPE Art and Design Science past papers in PDF format for free, along with the offical past paper booklet."
      }
      pathname={""}
      siteLanguage={"en"}
