...
const dlLink =
  "https://dl.dropbox.com/s/9l4pzd1e1k2566g/CAPE%20Management%20of%20Business%20Past%20Papers%20u1%20_%20U2%202005-201.pdf?dl=0";
const title = "Management of Business";

const MOB = props => (
  <Layout>
    <SEO
      title={
        "CAPE® Management of Business Past Papers eBook | CXC Spanish Online"
      }
      description={
        "Get the CAPE Management of Business past papers in PDF format for free, along with the offical past paper booklet."
      }
      pathname={""}
      siteLanguage={"en"}
