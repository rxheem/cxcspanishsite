...
const Terms = props => (
  <Layout>
    ...
    <Container>
      ...
      <p>Welcome to CXC Spanish Online!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of CXC Spanish Online's Website, located at https://www.cxcspanish.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use CXC Spanish Online if you do not
        ...
        Conditions Generator and the Terms & Conditions Generator.
      </p>
      <p>
      ...
      <h6>Cookies</h6>
      <p>
        We employ the use of cookies. By accessing CXC Spanish Online, you
        agreed to use cookies in agreement with the CXC Spanish Online's Privacy
        Policy.
      </p>
      <p>
      ...
      <h6>License</h6>
      <p>
        Unless otherwise stated, CXC Spanish Online and/or its licensors own the
        intellectual property rights for all material on CXC Spanish Online. All
        intellectual property rights are reserved. You may access this from CXC
        Spanish Online for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <ul>
        <li>Republish material from CXC Spanish Online</li>
        <li>Sell, rent or sub-license material from CXC Spanish Online</li>
        <li>Reproduce, duplicate or copy material from CXC Spanish Online</li>
        <li>Redistribute content from CXC Spanish Online</li>
      </ul>

      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website. CXC
        Spanish Online does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of CXC Spanish Online,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, CXC Spanish Online
      ...
      <p>
        CXC Spanish Online reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant CXC Spanish Online a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of CXC Spanish Online; and (d) the
      ...
      <p>
        ...
        e-mail to CXC Spanish Online. Please include your name, your
      ...
      <p>
        No use of CXC Spanish Online's logo or other artwork will be allowed for
