      ...
      class A {
        ...
        static activeSwFileName(e) {
          ...
          if ("akam-sw.js" == i) {
            const t = new URLSearchParams(
              new URL(e.active.scriptURL).search
            ).get("othersw");
            if (t)
              return (
                s.a.debug(
        ...
        installAlternatingWorker() {
          return c.a(this, void 0, void 0, function*() {
            ...
            s.a.debug(
              "[Service Worker Installation] Service worker installed."
            );
          });
        }
      }
            ...
            switch (e) {
              ...
              case y.a.SecureProxy:
                if (t === o.a.Host) {
                  ...
                  throw new InvalidStateError.a(
                    InvalidStateError.b.NoProxyFrame
                  );
                }
                return yield this.isSubscriptionExpiringForSecureIntegration();
      ...
      class f {
        ...
        static getMergedConfig(e, t) {
          ...
          return {
            ...
            emailAuthRequired:
              t.features.email && t.features.email.require_auth,
            userConfig: s,
          ...
          return (
            s.slidedown
              ? ((s.slidedown.enabled = !!s.slidedown.enabled),
                (s.slidedown.autoPrompt = s.slidedown.hasOwnProperty(
                  "autoPrompt"
                )
          ...
          switch (this.getIntegrationCapabilities(e).configuration) {
            case a.Dashboard:
              return {
                ...
                promptOptions: this.getPromptOptionsForDashboardConfiguration(
                  i
                ),
                welcomeNotification: {
      ...
      (function(e) {
        ...
        class y {
          ...
          static onNotificationClicked(e) {
            return n.a(this, void 0, void 0, function*() {
              b.a.debug(
                `Called %conNotificationClicked(${JSON.stringify(
                  e,
                  null,
                  4
                )}):`,
